...
// ⚠️ 虎牙播不了时的修复指南 ⚠️
// 1. 打开 https://github.com/wbt5/real-url 找到 huya.py
// 2. 对照它里面的版本号/UA/参数，替换下面所有标记了 [虎牙参数] 的行
// 3. 编译 -> D:\simple_live\
//
class HuyaSite implements LiveSite {
  static const baseUrl = "https://m.huya.com/";
  // [虎牙参数] 房间页爬虫 UA，如果取不到房间信息先改这个
  final String kUserAgent =
      "Mozilla/5.0 (Linux; Android 11; Pixel 5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.91 Mobile Safari/537.36 Edg/117.0.0.0";

  // [虎牙参数] 直播流请求 UA，最常改的参数，先查这个
  ...
  // [虎牙参数] Tars RPC 接口地址，很少改，但万一改了会完全连不上
  ...
  Future<String> getCndTokenInfoEx(String stream) async {
    // [虎牙参数] Tars RPC 函数名，如果请求失败可能是这个改了
    var func = "getCdnTokenInfoEx";
    var tid = HuyaUserId();
    // [虎牙参数] Tars RPC 内用的 UA，常跟 HYSDK_UA 一起变
